<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="liuyanban.aspx.cs" Inherits="liuyanban" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" DataKeyNames="id" Font-Size="1.5em">
      ...
      <Columns>
       <asp:BoundField DataField="id" HeaderText="树洞编号" ReadOnly="True" />
       <asp:BoundField DataField="liuyan" HeaderText="悄悄话" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:homeworkConnectionString2 %>" SelectCommand="SELECT * FROM [liuyanban]"></asp:SqlDataSource>

...
public partial class feedbackX : System.Web.UI.Page
{
    ...
    {
        string sqlstr = "delete from [feedback] where id='" + GridView1.DataKeys[e.RowIndex].Value.ToString() + "'";
    ...
    {
        sqlcon = new SqlConnection(strCon);
        string sqlstr = "update [feedback] set name='"
         + ((TextBox)(GridView1.Rows[e.RowIndex].Cells[1].Controls[0])).Text.ToString().Trim() + "',email='"
         + ((TextBox)(GridView1.Rows[e.RowIndex].Cells[2].Controls[0])).Text.ToString().Trim() + "',phone='"
         + ((TextBox)(GridView1.Rows[e.RowIndex].Cells[3].Controls[0])).Text.ToString().Trim() + "',text='"
